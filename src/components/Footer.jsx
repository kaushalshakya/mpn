...
const Footer = () => {
  ...
  return (
    <footer className="footer p-[1.37rem] bg-base-100 fixed bottom-0 text-neutral-content">
      <aside>
      ...
      <nav className="flex ml-[31rem] items-center gap-96">
        <div
        ...
        >
          <header className="footer-title ml-[7px]">Social</header>
          <div>
