...
const Footer = () => {
  ...
  return (
    <footer
      className={
        !fixedFooter
          ? "footer max-h-[75px] md:max-h-[100px] p-[1.3rem] items-center flex md:justify-between lg:justify-between justify-center bg-base-100 static bottom-0 text-neutral-content z-0"
          : "footer max-h-[75px] md:max-h-[100px] p-[1.3rem] items-center flex md:justify-between lg:justify-between justify-center bg-base-100 fixed bottom-0 text-neutral-content z-0"
      }
    >
