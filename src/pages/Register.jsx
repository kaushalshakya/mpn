...
const Register = () => {
  ...
  if (radio === "Business") {
    description = (
      <>
        <p>Add Your Business Help People To Find it Easily</p>
        <p>
          Register and add your business in the Market Place Portal. Promote
          your business and product through various posts and other activities.
          You are helping people to find your business and services easily who
          search for the same in Market Place Portal.
        </p>
      </>
    );
  } else if (radio === "Contributor") {
    description = (
      <>
        <p>
          Become A Contributor Earn A Mobile Re-Charge Worth Rs. 100 Or Rs 100
          In Your Esewa Account For Every 12 Valid Contribution
        </p>
        <p>
          If you signup as a contributor, you are able to add businesses as your
          contribution in Market Place Portal. Contributions should be valid and
          with permission to the business owners. Your contribution will be
          accepted only after the cross verification.
        </p>
        <p>
          You can earn a re-charge worth Rs. 100 Or Rs. 100 in your Esewa
          account for every 12 valid contributions you make.
        </p>
      </>
    );
  } else {
            ...
            <div className="card-body lg:w-[30rem] gap-0 h-full">
              ...
              <div>
                <p>
                  ...
                  <Link to={"/login"}>
                    <span className="text-[#D92689]">Login Now</span>
                  </Link>
                </p>
              </div>
